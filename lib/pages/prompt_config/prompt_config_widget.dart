...
class PromptConfigWidget extends StatefulWidget {
  ...
  final DocumentReference? promptId;

  static String routeName = 'PromptConfig';
  static String routePath = '/:instance/p/:promptId';

  @override
  State<PromptConfigWidget> createState() => _PromptConfigWidgetState();
}
...
class _PromptConfigWidgetState extends State<PromptConfigWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.prompt = await PromptRecord.getDocumentOnce(widget!.promptId!);
      await action_blocks.validaAcesso(
        context,
        instance: widget!.instance,
        prompt: _model.prompt?.promptId,
      );
      safeSetState(() {
        _model.nameTextController?.text = _model.prompt!.promptName;
      });
      safeSetState(() {
        _model.descriptionTextController?.text =
            _model.prompt!.promptDescription;
      });
      safeSetState(() {
        _model.visibilityValueController?.value =
            (_model.prompt?.visibility == 'INDIVIDUAL'
                ? 'Somente eu'
                : 'Todos');
      });
      safeSetState(() {
        _model.systemPromptTextController?.text = _model.prompt!.systemPrompt;
      });
      safeSetState(() {
        _model.webSearchPreviewValue = _model.prompt!.webSearch;
      });
      safeSetState(() {
        _model.instructionsTextController?.text = _model.prompt!.instructions;
      });
      safeSetState(() {
        _model.welcomeMessageTextController1?.text =
            _model.prompt!.chatWelcomeMessage;
      });
      safeSetState(() {
        _model.webSearchPreviewValue = _model.prompt!.webSearch;
      });
      safeSetState(() {
        _model.temperatureValue = _model.prompt!.temperature;
      });
      safeSetState(() {
        _model.topPValue = _model.prompt!.topP;
      });
      _model.instance = await queryParamsRecordOnce(
      ...
      _model.files = await OpenAIAPIGroup.listVectorStoreFilesCall.call(
        vectorStoreId: _model.prompt?.vectorStoreId,
      ...
      _model.agentFiles = getJsonField(
        ...
        true,
          ...
          .cast<dynamic>();
      _model.functionList =
          _model.prompt!.functions.toList().cast<DocumentReference>();
      safeSetState(() {});
    ...
    _model.nameTextController ??=
        TextEditingController(text: _model.prompt?.promptName);
    _model.nameFocusNode ??= FocusNode();

    _model.descriptionTextController ??=
        TextEditingController(text: _model.prompt?.promptDescription);
    _model.descriptionFocusNode ??= FocusNode();

    _model.welcomeMessageTextController1 ??=
        TextEditingController(text: _model.prompt?.chatWelcomeMessage);
    _model.welcomeMessageFocusNode1 ??= FocusNode();

    _model.systemPromptTextController ??=
        TextEditingController(text: _model.prompt?.systemPrompt);
    _model.systemPromptFocusNode ??= FocusNode();

    _model.instructionsTextController ??=
        TextEditingController(text: _model.prompt?.instructions);
    _model.instructionsFocusNode ??= FocusNode();

    _model.webSearchPreviewValue = false;
    _model.welcomeMessageTextController2 ??= TextEditingController();
    _model.welcomeMessageFocusNode2 ??= FocusNode();
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      hintText:
                                                          'Descreva o seu prompt para que outros usuários saibam do que ele trata.',
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  TextFormField(
                                                    controller: _model
                                                        .welcomeMessageTextController1,
                                                    focusNode: _model
                                                        .welcomeMessageFocusNode1,
                                                    autofocus: false,
                                                    obscureText: false,
                                                    decoration: InputDecoration(
                                                      hintText:
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Defina quem pode ter acesso à este prompt.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium
                                                        .override(
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Define o nível de criatividade de seu prompt. Aumente a temperature para deixar a IA mais criativa; diminua para respostas diretas e seguras.',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Define o nível de precisão de seu prompt. Reduza para buscar respostas com mais alto nível de precisão.',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
                                                      ...
                                                      FFButtonWidget(
                                                        onPressed: () async {
                                                          ...
                                                          if (selectedFiles !=
                                                              null) {
                                                            safeSetState(() =>
                                                                _model.isDataUploading_uploadVs =
                                                                    true);
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      FlutterFlowIconButton(
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          _model.deleteVsFile = await OpenAIAPIGroup
                                                                              .deleteVectorStoreFileCall
                                                                              .call(
                                                                            vectorStoreId:
                                                                                _model.prompt?.vectorStoreId,
                                                                            fileId:
                                                                                getJsonField(
                                                                              vFileItem,
                                                                              r'''$.id''',
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Como deseja que o assistente retorne seus dados.\n1️⃣ Texto: O assistente retornará somente texto como saída\n2️⃣ JSON: O assistente retornará os dados de forma estruturada em formato json_schema. OBS: Deve haver um campo data --> text com a resposta do assistente em todas as requisições.',
                                                    ...
                                                    if (_model.outputValue ==
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          TextFormField(
                                                            controller: _model
                                                                .welcomeMessageTextController2,
                                                            focusNode: _model
                                                                .welcomeMessageFocusNode2,
                                                            autofocus: false,
                                                            obscureText: false,
                                                            decoration:
                                                                InputDecoration(
                                      ...
                                      onPressed: () async {
                                        await _model.prompt!.reference
                                          ...
                                          chatWelcomeMessage: _model
                                              .welcomeMessageTextController1
                                              .text,
                                          visibility: _model.visibilityValue ==
                                                  'Somente eu'
                                              ? 'INDIVIDUAL'
                                              : 'INSTANCE',
                                          webSearch:
                                              _model.webSearchPreviewValue,
                                          temperature: _model.temperatureValue,
                                          topP: _model.topPValue,
                                        ));
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(
